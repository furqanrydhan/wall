  ...
  render() {
    ...
    return <div className='modal'>
      <div className='post-edit'>
        <button className='modal-close' onClick={this.home}></button>
        ...
        <div className='wall-item--inner--body'>
          <div className='wall-item--message'>
            <TextArea className='wall-item--message--text' placeholder="what's happening ?"/>
          </div>
          {this.renderQuote()}
        </div>
        </div>
          ...
          <div className='post-edit--actions'>
            <div className='post-edit--options'>
              <button className='post-edit--options--item'>
                <svg width="33px" height="22px" viewBox="307 225 44 27" version="1.1">
              ...
              <button className='post-edit--options--item'>
                <svg width="33px" height="22px" viewBox="6833 3731 96 86" version="1.1">
              ...
              <button className='post-edit--options--item'>
                <svg width="33px" height="22px" viewBox="0 0 146 118" version="1.1">
            ...
            <button className='post-edit--send'>Send</button>
          </div>
        </div>
