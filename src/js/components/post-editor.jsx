          ...
          <div className='post-edit--actions'>
            <div className='post-edit--options'>
              <button className='post-edit--options--item' style={{display: "none"}}>
                <svg width="100px" height="72px" viewBox="307 225 44 27" version="1.1">
              ...
              <button className='post-edit--options--item' onClick={this.onPhoto}>
                <svg width="100px" height="72px" viewBox="6833 3731 96 86" version="1.1">
              ...
              <button className='post-edit--options--item' onClick={this.onPhoto}>
                <svg width="100px" height="72px" viewBox="0 0 146 118" version="1.1">
