...
class WallItem extends React.Component {
    ...
    if (this.props.type === 'quote') {
      return <div className="wall-item--meta quote">
        ...
        <div className='wall-item--meta--text'>
          <span className='wall-item--meta--text--label'>{this.props.item.name}</span>
        </div>
      </div>
    } else {
      return <div className="wall-item--meta">
        ...
        <div className='wall-item--meta--text'>
          <span className='wall-item--meta--text--nanme'>{this.props.item.username}</span>
  ...
  renderMessage(){
    ...
    return <div className='wall-item--message'>
      <span className='wall-item--message--text'
 ...
 renderFooter(){
    ...
    return <div className="wall-item--footer">
       <button className="wall-item--footer--views">{text}</button> 
    </div>
    } else {
      return;
    }
